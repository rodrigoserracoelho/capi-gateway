...
public class SwaggerRoutePublisher extends RouteBuilder {
    ...
    public SwaggerRoutePublisher(CamelContext context, CamelUtils camelUtils, GrafanaUtils grafanaUtils, ThrottlingManager throttlingManager, SwaggerParser swaggerParser, Api api) {
        super(context);
        this.api = api;
